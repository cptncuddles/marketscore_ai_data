...
json_files = glob.glob("C:\\Users\\17197\\Documents\\Coding Projects\\Market Score Data\\MSCounts Ticker\\*json")
...
#Need to use zip for this double iterator so that each name get's paired properly with it's corresponding file.   
            for df, name in zip(df_list, names):
                df.to_csv(f"C:\\Users\\17197\\Documents\\Coding Projects\\Market Score Data\\MSCounts Ticker\\{name}.csv", index=False)
